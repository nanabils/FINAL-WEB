...
// Ambil data pemesanan untuk akun yang login
$stmt = $conn->prepare("SELECT pickup_location, dropoff_location, pickup_date, dropoff_date, pickup_time, created_at FROM car_rentals WHERE username = ?");
...
if ($result->num_rows > 0) {
    ...
    $dataTable = "<tr><td colspan='6'>Belum ada data pemesanan.</td></tr>";
}
...
<body>
    ...
    <div class="container">
        ...
        <a href="reservasisaya.html" class="menu-button active">
