...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($updateStmt->execute()) {
        echo "<script>alert('Password berhasil diupdate!'); window.location.href = 'ProfileAdmin.php';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <a href="passAdmin.php" class="menu-button active">
            <img src="https://img.icons8.com/ios-glyphs/30/66a1ed/lock.png" alt="icon"> Kata Sandi
        </a>
        <a href="reservasiAdmin.php" class="menu-button">
